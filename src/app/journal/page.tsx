    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="space-y-8">
        <article className="border border-teal-900 p-6">
          ...
          <p className="mb-4">
            Les systèmes de surveillance sont de plus en plus sophistiqués. Aujourd'hui, j'ai réussi
            à contourner le nouveau pare-feu du secteur 7. Je dois partager ces informations avec le
            reste de la résistance.
          </p>
        ...
        <article className="border border-teal-900 p-6">
          ...
          <p className="mb-4">
            La réunion d'hier a été interrompue. Trois des nôtres ont été capturés. Nous devons être
            plus prudents. Les codes d'accès ont été changés. Nouvelle fréquence établie.
          </p>
